        ...
        <div class="card-body">
            ...
            <form method="post" action="{{ route('issue.update', $issue->id) }}">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input name="active" id="active" class="form-control @error('active') is-invalid @enderror" type="checkbox" data-toggle="toggle" data-onstyle="success" data-offstyle="danger" {{ old('active') || $issue->active ? 'checked' : '' }}>
                        @error('active')
                        <div class="invalid-feedback">
                            <strong>{{ $message }}</strong>
                        </div>
