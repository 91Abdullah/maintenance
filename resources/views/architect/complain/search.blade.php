...
@section('content')
    ...
    <div class="main-card mb-3 card">
        <div class="card-body">
            <form action="" id="searchComplain">
                <div class="form-group row">
                    <label for="query" class="col-form-label col-sm-2">Complain Number</label>
                    <div class="col-sm-10">
...
@push('scripts')
    ...
    <script>
        ...
        let form = document.getElementById('searchComplain');
        let url = "{!! route('complain.search') !!}";
        let data = null;
